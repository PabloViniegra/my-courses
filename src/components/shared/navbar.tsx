...
export default function Navbar({ user, localUser }: NavbarProps) {
                ...
                {NAVIGATION_LINKS.map((link, index) => (
                  <NavigationMenuItem key={index}>
                    <NavigationMenuLink
                      ...
                      href={link.href}
                      className="text-muted-foreground hover:text-primary py-1.5 font-medium font-sans"
                    >
                      {link.label}
                    </NavigationMenuLink>
                  </NavigationMenuItem>
